...
YY_ACTION(void) yy_2_AE(char *yytext, int yyleng)
{
#define r yyval[-1]
#define l yyval[-2]
#define op yyval[-3]
#define n yyval[-4]
  yyprintf((stderr, "do yy_2_AE\n"));
...
{  int yypos0= yypos, yythunkpos0= yythunkpos;  yyDo(yyPush, 4, 0);
  yyprintf((stderr, "%s\n", "AE"));
  {  int yypos12= yypos, yythunkpos12= yythunkpos;  if (!yy_Number()) goto l13;  yyDo(yySet, -4, 0);  yyDo(yy_1_AE, yybegin, yyend);  goto l12;
  l13:;	  yypos= yypos12; yythunkpos= yythunkpos12;  if (!yy_LBRACE()) goto l11;  if (!yy_OP()) goto l11;  yyDo(yySet, -3, 0);  if (!yy_AE()) goto l11;  yyDo(yySet, -2, 0);  if (!yy_AE()) goto l11;  yyDo(yySet, -1, 0);  if (!yy_RBRACE()) goto l11;  yyDo(yy_2_AE, yybegin, yyend);
  }
  l12:;	
  yyprintf((stderr, "  ok   %s @ %s\n", "AE", yybuf+yypos));  yyDo(yyPop, 4, 0);
  return 1;
